...
ActiveRecord::Schema.define(version: 20140221005908) do
  ...
  add_index "user_tokens", ["session_token"], name: "index_user_tokens_on_session_token", unique: true, using: :btree
